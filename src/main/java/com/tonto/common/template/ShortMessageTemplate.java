 ...
 *
 */
public class ShortMessageTemplate implements MessageTemplate {
	
	private String template;
	
	public ShortMessageTemplate(InputStream input) throws IOException
	{
		setTemplateInputStream(input);
	}
	
	public ShortMessageTemplate(String template)
	{
